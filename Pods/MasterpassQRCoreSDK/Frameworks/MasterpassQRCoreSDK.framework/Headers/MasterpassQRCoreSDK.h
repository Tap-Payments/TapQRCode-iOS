...
//! Project version number for MasterpassQRCoreSDK.
FOUNDATION_EXPORT double MasterpassQRCoreSDKVersionNumber;

//! Project version string for MasterpassQRCoreSDK.
FOUNDATION_EXPORT const unsigned char MasterpassQRCoreSDKVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <MasterpassQRCoreSDK/PublicHeader.h>
